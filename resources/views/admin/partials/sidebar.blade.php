<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <a href="{{ url('/admin/dashboard') }}" class="brand-link">
    ...
    <span class="brand-text font-weight-light">Go! Ponto a Ponto</span>
  </a>

  <div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{ Auth::user()->avatar ? asset('storage/'.Auth::user()->avatar) : asset('resources/img/person-fill.svg') }}" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
